...
import CardsIllustration from "@/components/launch-ui/illustrations/cards";
import CarouselIllustration from "@/components/launch-ui/illustrations/carousel";

import { Section } from "../../ui/section";
import InfrastructureIllustration from "../../illustrations/infrastructure";
    ...
    },
    {
      ...
      visual: (
        <div className="relative min-h-[240px]">
          <CarouselIllustration className="absolute top-1/2 left-1/2 -mt-24 h-[512px] w-[512px] -translate-x-1/2 -translate-y-1/2" />
        </div>
      ),
              ...
              if (index === 0) {
                return (
                  <Card key={index} className={tile.size}>
                    <CardLink />
                    <CardContent className={tile.contentClassName}>
                      {tile.icon}
