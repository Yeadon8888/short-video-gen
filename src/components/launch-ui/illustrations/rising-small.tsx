...
function RisingSmallIllustration() {
  return (
    ...
    >
      <div className="dark:border-brand bg-background/50 border-brand-foreground/80 absolute top-0 -left-[50%] z-10 w-[200%] overflow-hidden rounded-[100%] border-4 pt-[100%] dark:shadow-[0px_0px_12px_var(--brand),_0px_0px_64px_var(--brand-foreground),0px_0px_12px_var(--brand)_inset]">
        <div
