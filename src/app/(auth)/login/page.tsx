  ...
  return (
    <div className="vc-glass w-full max-w-sm space-y-6 rounded-2xl p-8 vc-animate-in">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-[var(--vc-text-muted)]">或</span>
        <div className="h-px flex-1 bg-[var(--vc-border)]" />
      </div>
      ...
      <form action={signInWithGoogle}>
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-3 rounded-[var(--vc-radius-md)] border border-[var(--vc-border)] bg-[var(--vc-bg-root)] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[var(--vc-bg-surface)]"
        >
          <GoogleIcon />
          使用 Google 登录
        </button>
